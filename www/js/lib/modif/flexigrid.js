...
(function ($) {
	...
	$.addFlex = function (t, p) {
		...
		if (p.usepager) {
			...
			$(g.bDiv).after(g.pDiv);
			var html = ' <div class="pGroup"><div class="pFirst pButton"><span></span></div>' +
			'<div class="pPrev pButton"><span></span></div></div>' +
			'<div class="btnseparator"></div>' +
			'<div class="pGroup"> <div class="pNext pButton"><span></span></div>' +
			'<div class="pLast pButton"><span></span></div></div>' +
			'<div class="btnseparator"></div>' +
			'<div class="pGroup"><span class="pcontrol">' + p.pagetext + ' <input type="text" size="4" value="1" /> ' + p.outof + ' <span> 1 </span></span></div>' +
			'<div class="btnseparator"></div> <div class="pGroup"> <div class="pReload pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>';
	...
	$.fn.flexReload = function (p) { // function to reload grid
		return this.each(function () {
			if (this.grid && this.p.url) {
				if ( p ) this.p.newp = null;										// Dan 2016-01-22
				this.grid.populate();
			}
		});
	}; //end flexReload
