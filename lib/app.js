...
import { $, $$, br, remote, createElement, loadCSS, translate } from "./util.js";
...
var App = props => {
  ...
  "br-container", [createComponentVNode(2, Navbar, { children: [createVNode(1, "div",
    ...
    "space", [createVNode(1, "i", "fa fa-list-ol"), createVNode(1, "span")], 4, { "title": "list", "onClick": toggleList }), createVNode(1, "a",
...
App.defaultHooks = {
  onComponentDidMount(domNode) {
    ...
    br.dlg = $('#br-dialog');
    if (br.lang) {
      remote({ db: br.app, coll: '_locales', fields: 'default,' + br.lang }).
      then(res => {
        if (!res.err) {
          br.locales = res;
