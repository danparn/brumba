...
var App = props => {
  ...
  "br-container", [createComponentVNode(2, Navbar, { children: [createVNode(1, "div",
    ...
    "space", [createVNode(1, "i", "fa fa-file"), createVNode(1, "span")], 4, { "onClick": clear }), createVNode(1, "a", null, [createVNode(1, "i",
    "fa fa-save"), createVNode(1, "span")], 4, { "id": "br-save", "onClick": save }), createVNode(1, "a", null, [createVNode(1, "i",
    "fa fa-search"), createVNode(1, "span")], 4, { "onClick": formSearch }), createVNode(1, "a", null, [createVNode(1, "i",
    "fa fa-search-plus"), createVNode(1, "span")], 4, { "onClick": pageSearch }), createVNode(1, "a",
    "space", [createVNode(1, "i", "fa fa-list-ol"), createVNode(1, "span")], 4, { "onClick": toggleList }), createVNode(1, "a",
    "align-right", [createVNode(1, "i", "fa fa-trash"), createVNode(1, "span")], 4, { "onClick": formDelete })] }), createVNode(1, "nav",
