...
import { objLess, toJSON, strSplit } from "./common.js";
import { Message } from "./inferno-bulma.js";
import { $, e$, br, remote, modified, createElement, translate } from "./util.js";
...
export var Navbar = props => {
  ...
  "br-bars", createVNode(1, "i", "fa fa-bars"), 2, { "title": "menu", "onClick": openSidebar }),
  props.children], 0), 2);
...
export var confirmModal = (message, okHandler, color) => {
  ...
  render(null, br.dlg);
  br.dlg.innerHTML = "\n\t\t<div class=\"modal is-active\">\n\t\t\t<div class=\"modal-background\"></div>\n\t\t\t<div class=\"modal-card\">\n\t\t\t\t<header class=\"modal-card-head\">\n\t\t\t\t\t<p class=\"modal-card-title\">".concat(




  translate('Confirmation needed'), "</p>\n\t\t\t\t\t<button class=\"delete\" aria-label=\"close\"></button>\n\t\t\t\t</header>\n\t\t\t\t<section class=\"modal-card-body\">\n\t\t\t\t\t").concat(
  ...
  color, " mod-ok\">").concat(translate('Ok'), "</button>\n\t\t\t\t\t<button class=\"button mod-close\">").concat(
...
/* 
    *  Tooltip
    */
export var tooltip = message => {
  var tt = createElement("\n\t\t<span class=\"tag is-dark\">".concat(
  message, "</span>\n\t"));
