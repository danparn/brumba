...
import { $, $$, e$$, br, remote, modified, createElement, createStyle, loadCSS, unselect } from "./util.js";
import { newPage, tileEvents, tabEvents } from "./ide-page.js";
import { pageRender, toggleList, pageWrapper, createScript } from "./page.js";
...
var Ide = props => {
  ...
  var renderNav = () => {
    ...
    "br-container", [createComponentVNode(2, Navbar, { children: [createVNode(1, "div",
      ...
      "space", [createVNode(1, "i", "fa fa-save"), createVNode(1, "span", null, "save", 16)], 4, { "id": "br-save", "onClick": onSave }), createVNode(1, "a", null, [createVNode(1, "i",
      ...
      "fa fa-css3"), createVNode(1, "span", null, "css", 16)], 4, { "onClick": onEditor }), createVNode(1, "a", null, [createVNode(1, "i",
      "fa fa-html5"), createVNode(1, "span", null, "html", 16)], 4, { "onClick": onEditor }), createVNode(1, "a", null, createVNode(64, "input",
      "input is-small br-workon", null, 1, { "onchange": workonChange }), 2), createVNode(1, "a",
      "space", [createVNode(1, "i", "fa fa-list-ol"), createVNode(1, "span")], 4, { "onClick": toggleList }), createVNode(1, "a", null, [createVNode(1, "i",
      "fa fa-border-none"), createVNode(1, "span")], 4, { "onClick": borders }), createVNode(1, "a",
