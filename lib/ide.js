...
import { objLess, hex24 } from "./common.js";
...
import { newGrid, gridRender, moveColumn } from "./ide-grid.js";
import { newReport, openReport } from "./ide-report.js";
import { properties, locales } from "./ide-props.js";
...
var Ide = props => {
  ...
  var renderNav = () => {
    ...
    "br-container", [createComponentVNode(2, Navbar, { children: [createVNode(1, "div",
      ...
      "fab fa-html5"), createVNode(1, "span", null, "html", 16)], 4, { "onClick": onEditor }), createVNode(1, "a", null, [createVNode(1, "i",
      "fa fa-globe"), createVNode(1, "span", null, "locales", 16)], 4, { "onClick": onLocales }), createVNode(1, "a", null, createVNode(64, "input",
...
/* 
    ...
    */
var del = cb => {
  var msg = 'Are you sure you want to delete this page/form?';
  var onOk = e => {
    if (br.wo.id) {
